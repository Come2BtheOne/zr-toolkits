...
function Dataset(targetClass) {
    return /** @class */ (function (_super) {
         ...
         * @return {boolean}
         */
        Dataset.isEmptyString = function (value) {
         ...
         * @return {boolean}    判断结果
         */
        Dataset.isObject = function (value) {
         ...
         * @return {boolean}  判断结果
         */
        Dataset.isEmptyObject = function (obj) {
         ...
         */
        Dataset.deWeightThree = function (arr, key) {
            var obj = {};
         ...
         */
        Dataset.searchValueInTree = function (arr, keyName, keyValue, multilevelName) {
...
function Random(targetClass) {
    return /** @class */ (function (_super) {
       ...
       */
        Random.shuffleRandom = function (arr) {
            var result = [], random;
            while (arr.length > 0) {
         ...
         */
        Random.creatRandom = function (min, max, exact) {
...
function Character(targetClass) {
    return /** @class */ (function (_super) {
         ...
         */
        Character.getUrlParamsValue = function (url, key) {
            if (URL) {
         ...
         * @return {string}
         */
        Character.trim = function (str, trimType) {
         ...
         * @return {string}
         */
        Character.changeCase = function (str, caseType) {
...
function Regexp(targetClass) {
    return /** @class */ (function (_super) {
         ...
         * @return {boolean}
         */
        Regexp.isMobilePhone = function (str) {
         ...
         * @return {boolean}
         */
        Regexp.isTelephone = function (str) {
         ...
         * @return {boolean}
         */
        Regexp.regCheckString = function (str, key) {
         ...
         * @return {boolean}
         */
        Regexp.strictCheckIDCard = function (sId) {
...
function Time(targetClass) {
    return /** @class */ (function (_super) {
         ...
         */
        Time.formatMs = function (ms, hour12) {
         ...
         */
        Time.calculateTimeDifference = function (endTime, startTime, justHour) {
...
function Num(targetClass) {
    return /** @class */ (function (_super) {
         ...
         */
        Num.formatMoney = function (num, precision) {
         ...
         * @param {number} precision  精确到几位小数
         */
        Num.makePercent = function (num, precision) {
            if (precision === void 0) { precision = 2; }
            var _num = +num;
...
function SystemApi(targetClass) {
    return /** @class */ (function (_super) {
         ...
         */
        SystemApi.phoneCall = function (receiver) {
         ...
         */
        SystemApi.sendMessage = function (receiver) {
         ...
         * @returns {Promise}
         */
        SystemApi.share = function (shareOptions) {
         ...
         * @returns
         */
        SystemApi.notify = function (title, options, events) {
        ...
        SystemApi.doNotify = function (title, options, events) {
            if (options === void 0) { options = {}; }
         ...
         * @returns {string} 图片地址
         */
        SystemApi.captureVideo = function (videoEl) {
            var canvasEl;
            var dataUrl;
            try {
...
function Other(targetClass) {
    return /** @class */ (function (_super) {
         ...
         */
        Other.syncLoadScript = function (src, callback) {
            if (callback) {
         ...
         */
        Other.downloadByUrl = function (url, fileName) {
         ...
         */
        Other.downloadByBob = function (blob, fileName) {
            if (fileName === void 0) { fileName = "download"; }
         ...
         * @param {string} str
         */
        Other.copyToClipboard = function (str) {
         ...
         */
        Other.hasClass = function (el, className) {
         ...
         */
        Other.getScrollPosition = function (el) {
            return {
         ...
         */
        Other.watchVisibility = function (onHide, onShow) {
         ...
         *  禁止右键、选择、复制
         */
        Other.disableWindowEvent = function () {
