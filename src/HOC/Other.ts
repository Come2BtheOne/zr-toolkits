...
export class Other {
   ...
   */
  public syncLoadScript(src: string, callback?: Function): Promise<null> | void {
    if (callback) {
   ...
   */
  public downloadByUrl(url: string, fileName: string = 'download'): void {
   ...
   */
  public downloadByBob(blob: Blob, fileName: string = "download"): void {
   ...
   */
  public hasClass(el: HTMLElement, className: string): boolean {
   ...
   */
  public getScrollPosition(el: any): { x: number, y: number } {
    return {
   ...
   */
  public watchVisibility(onHide?: () => void, onShow?: () => void) {
